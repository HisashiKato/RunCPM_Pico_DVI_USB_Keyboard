...
#ifdef ABDOS
    #define CCPHEAD    "\r\nRunCPM [" TEXT_BOLD "v" VERSION "" TEXT_NORMAL "] => CCP:[" TEXT_BOLD "" CCPname "" TEXT_NORMAL "] => TPA:[" TEXT_BOLD "" STR(TPASIZE) "K" "" TEXT_NORMAL "] [" TEXT_BOLD "" ABD "" TEXT_NORMAL "]"  DBG "\r\n"
#else
    #define CCPHEAD    "\r\nRunCPM [" TEXT_BOLD "v" VERSION "" TEXT_NORMAL "] => CCP:[" TEXT_BOLD "" CCPname "" TEXT_NORMAL "] => TPA:[" TEXT_BOLD "" STR(TPASIZE) "K" "" TEXT_NORMAL "] "  DBG "\r\n"
#endif 
